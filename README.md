...
Clone:
```sh
  git clone https://github.com/AliShahSafdari/JavaScriptCapstone
```
...
Feel free to check the [issues page](https://github.com/AliShahSafdari/JavaScriptCapstone/issues).
